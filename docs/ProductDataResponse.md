# DigitalFemsa.net.Model.ProductDataResponse
...
**Metadata** | **Dictionary&lt;string, Object&gt;** | Arbitrary key-value data for your internal use. Keys should be strings; values can be any JSON value.  | [optional] 
**Id** | **string** |  | [optional] 
