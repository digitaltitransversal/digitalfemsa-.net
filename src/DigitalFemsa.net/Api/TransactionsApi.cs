...
namespace DigitalFemsa.net.Api
{
    ...
    public partial class TransactionsApi : ITransactionsApi
    {
        ...
        /// <returns></returns>
        public TransactionsApi(DigitalFemsa.net.Client.Configuration configuration)
        {
        ...
        public TransactionsApi(DigitalFemsa.net.Client.ISynchronousClient client, DigitalFemsa.net.Client.IAsynchronousClient asyncClient, DigitalFemsa.net.Client.IReadableConfiguration configuration)
        {
        ...
        {
            DigitalFemsa.net.Client.ApiResponse<TransactionResponse> localVarResponse = GetTransactionWithHttpInfo(id, acceptLanguage, xChildCompanyId);
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of TransactionResponse</returns>
        public DigitalFemsa.net.Client.ApiResponse<TransactionResponse> GetTransactionWithHttpInfo(string id, string acceptLanguage = default(string), string xChildCompanyId = default(string), int operationIndex = 0)
        {
            // verify the required parameter 'id' is set
            if (id == null)
            {
                throw new DigitalFemsa.net.Client.ApiException(400, "Missing required parameter 'id' when calling TransactionsApi->GetTransaction");
            }
        ...
        {
            DigitalFemsa.net.Client.ApiResponse<TransactionResponse> localVarResponse = await GetTransactionWithHttpInfoAsync(id, acceptLanguage, xChildCompanyId, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        {
            DigitalFemsa.net.Client.ApiResponse<GetTransactionsResponse> localVarResponse = GetTransactionsWithHttpInfo(acceptLanguage, xChildCompanyId, limit, next, previous, id, chargeId, type, currency);
            return localVarResponse.Data;
        }
        ...
        public DigitalFemsa.net.Client.ApiResponse<GetTransactionsResponse> GetTransactionsWithHttpInfo(string acceptLanguage = default(string), string xChildCompanyId = default(string), int? limit = default(int?), string next = default(string), string previous = default(string), string id = default(string), string chargeId = default(string), string type = default(string), string currency = default(string), int operationIndex = 0)
        {
            ...
            if (id != null)
            {
                localVarRequestOptions.QueryParameters.Add(DigitalFemsa.net.Client.ClientUtils.ParameterToMultiMap("", "id", id));
            }
            if (chargeId != null)
            {
                localVarRequestOptions.QueryParameters.Add(DigitalFemsa.net.Client.ClientUtils.ParameterToMultiMap("", "charge_id", chargeId));
            }
            if (type != null)
            {
                localVarRequestOptions.QueryParameters.Add(DigitalFemsa.net.Client.ClientUtils.ParameterToMultiMap("", "type", type));
            }
            if (currency != null)
            {
                localVarRequestOptions.QueryParameters.Add(DigitalFemsa.net.Client.ClientUtils.ParameterToMultiMap("", "currency", currency));
            }
            if (acceptLanguage != null)
            {
                localVarRequestOptions.HeaderParameters.Add("Accept-Language", DigitalFemsa.net.Client.ClientUtils.ParameterToString(acceptLanguage)); // header parameter
        ...
        {
            DigitalFemsa.net.Client.ApiResponse<GetTransactionsResponse> localVarResponse = await GetTransactionsWithHttpInfoAsync(acceptLanguage, xChildCompanyId, limit, next, previous, id, chargeId, type, currency, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
