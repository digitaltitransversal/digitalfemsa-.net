...
namespace DigitalFemsa.net.Api
{
    ...
    public partial class EventsApi : IEventsApi
    {
        ...
        /// <returns></returns>
        public EventsApi(DigitalFemsa.net.Client.Configuration configuration)
        {
        ...
        public EventsApi(DigitalFemsa.net.Client.ISynchronousClient client, DigitalFemsa.net.Client.IAsynchronousClient asyncClient, DigitalFemsa.net.Client.IReadableConfiguration configuration)
        {
        ...
        {
            DigitalFemsa.net.Client.ApiResponse<EventResponse> localVarResponse = GetEventWithHttpInfo(id, acceptLanguage, xChildCompanyId);
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of EventResponse</returns>
        public DigitalFemsa.net.Client.ApiResponse<EventResponse> GetEventWithHttpInfo(string id, string acceptLanguage = default(string), string xChildCompanyId = default(string), int operationIndex = 0)
        {
            // verify the required parameter 'id' is set
            if (id == null)
            {
                throw new DigitalFemsa.net.Client.ApiException(400, "Missing required parameter 'id' when calling EventsApi->GetEvent");
            }
        ...
        {
            DigitalFemsa.net.Client.ApiResponse<EventResponse> localVarResponse = await GetEventWithHttpInfoAsync(id, acceptLanguage, xChildCompanyId, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        {
            DigitalFemsa.net.Client.ApiResponse<GetEventsResponse> localVarResponse = GetEventsWithHttpInfo(acceptLanguage, xChildCompanyId, limit, search, next, previous);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of GetEventsResponse</returns>
        public DigitalFemsa.net.Client.ApiResponse<GetEventsResponse> GetEventsWithHttpInfo(string acceptLanguage = default(string), string xChildCompanyId = default(string), int? limit = default(int?), string search = default(string), string next = default(string), string previous = default(string), int operationIndex = 0)
        {
            DigitalFemsa.net.Client.RequestOptions localVarRequestOptions = new DigitalFemsa.net.Client.RequestOptions();
        ...
        {
            DigitalFemsa.net.Client.ApiResponse<GetEventsResponse> localVarResponse = await GetEventsWithHttpInfoAsync(acceptLanguage, xChildCompanyId, limit, search, next, previous, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        {
            DigitalFemsa.net.Client.ApiResponse<EventsResendResponse> localVarResponse = ResendEventWithHttpInfo(eventId, webhookLogId, acceptLanguage);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of EventsResendResponse</returns>
        public DigitalFemsa.net.Client.ApiResponse<EventsResendResponse> ResendEventWithHttpInfo(string eventId, string webhookLogId, string acceptLanguage = default(string), int operationIndex = 0)
        {
            // verify the required parameter 'eventId' is set
            if (eventId == null)
            {
                throw new DigitalFemsa.net.Client.ApiException(400, "Missing required parameter 'eventId' when calling EventsApi->ResendEvent");
            }

            // verify the required parameter 'webhookLogId' is set
            if (webhookLogId == null)
            {
                throw new DigitalFemsa.net.Client.ApiException(400, "Missing required parameter 'webhookLogId' when calling EventsApi->ResendEvent");
            }
            ...
            localVarRequestOptions.PathParameters.Add("event_id", DigitalFemsa.net.Client.ClientUtils.ParameterToString(eventId)); // path parameter
            localVarRequestOptions.PathParameters.Add("webhook_log_id", DigitalFemsa.net.Client.ClientUtils.ParameterToString(webhookLogId)); // path parameter
            if (acceptLanguage != null)
            {
                localVarRequestOptions.HeaderParameters.Add("Accept-Language", DigitalFemsa.net.Client.ClientUtils.ParameterToString(acceptLanguage)); // header parameter
            }
        ...
        {
            DigitalFemsa.net.Client.ApiResponse<EventsResendResponse> localVarResponse = await ResendEventWithHttpInfoAsync(eventId, webhookLogId, acceptLanguage, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
