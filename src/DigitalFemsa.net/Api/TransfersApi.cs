...
namespace DigitalFemsa.net.Api
{
    ...
    public partial class TransfersApi : ITransfersApi
    {
        ...
        /// <returns></returns>
        public TransfersApi(DigitalFemsa.net.Client.Configuration configuration)
        {
        ...
        public TransfersApi(DigitalFemsa.net.Client.ISynchronousClient client, DigitalFemsa.net.Client.IAsynchronousClient asyncClient, DigitalFemsa.net.Client.IReadableConfiguration configuration)
        {
        ...
        {
            DigitalFemsa.net.Client.ApiResponse<TransferResponse> localVarResponse = GetTransferWithHttpInfo(id, acceptLanguage, xChildCompanyId);
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of TransferResponse</returns>
        public DigitalFemsa.net.Client.ApiResponse<TransferResponse> GetTransferWithHttpInfo(string id, string acceptLanguage = default(string), string xChildCompanyId = default(string), int operationIndex = 0)
        {
            // verify the required parameter 'id' is set
            if (id == null)
            {
                throw new DigitalFemsa.net.Client.ApiException(400, "Missing required parameter 'id' when calling TransfersApi->GetTransfer");
            }
        ...
        {
            DigitalFemsa.net.Client.ApiResponse<TransferResponse> localVarResponse = await GetTransferWithHttpInfoAsync(id, acceptLanguage, xChildCompanyId, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        {
            DigitalFemsa.net.Client.ApiResponse<GetTransfersResponse> localVarResponse = GetTransfersWithHttpInfo(acceptLanguage, xChildCompanyId, limit, search, next, previous);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of GetTransfersResponse</returns>
        public DigitalFemsa.net.Client.ApiResponse<GetTransfersResponse> GetTransfersWithHttpInfo(string acceptLanguage = default(string), string xChildCompanyId = default(string), int? limit = default(int?), string search = default(string), string next = default(string), string previous = default(string), int operationIndex = 0)
        {
            DigitalFemsa.net.Client.RequestOptions localVarRequestOptions = new DigitalFemsa.net.Client.RequestOptions();
        ...
        {
            DigitalFemsa.net.Client.ApiResponse<GetTransfersResponse> localVarResponse = await GetTransfersWithHttpInfoAsync(acceptLanguage, xChildCompanyId, limit, search, next, previous, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
