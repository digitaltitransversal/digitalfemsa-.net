...
namespace DigitalFemsa.net.Api
{
    ...
    public partial class CompaniesApi : ICompaniesApi
    {
        ...
        /// <returns></returns>
        public CompaniesApi(DigitalFemsa.net.Client.Configuration configuration)
        {
        ...
        public CompaniesApi(DigitalFemsa.net.Client.ISynchronousClient client, DigitalFemsa.net.Client.IAsynchronousClient asyncClient, DigitalFemsa.net.Client.IReadableConfiguration configuration)
        {
        ...
        {
            DigitalFemsa.net.Client.ApiResponse<GetCompaniesResponse> localVarResponse = GetCompaniesWithHttpInfo(acceptLanguage, limit, search, next, previous);
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of GetCompaniesResponse</returns>
        public DigitalFemsa.net.Client.ApiResponse<GetCompaniesResponse> GetCompaniesWithHttpInfo(string acceptLanguage = default(string), int? limit = default(int?), string search = default(string), string next = default(string), string previous = default(string), int operationIndex = 0)
        {
        ...
        {
            DigitalFemsa.net.Client.ApiResponse<GetCompaniesResponse> localVarResponse = await GetCompaniesWithHttpInfoAsync(acceptLanguage, limit, search, next, previous, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        {
            DigitalFemsa.net.Client.ApiResponse<CompanyResponse> localVarResponse = GetCompanyWithHttpInfo(id, acceptLanguage);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of CompanyResponse</returns>
        public DigitalFemsa.net.Client.ApiResponse<CompanyResponse> GetCompanyWithHttpInfo(string id, string acceptLanguage = default(string), int operationIndex = 0)
        {
            // verify the required parameter 'id' is set
            if (id == null)
            {
                throw new DigitalFemsa.net.Client.ApiException(400, "Missing required parameter 'id' when calling CompaniesApi->GetCompany");
            }
        ...
        {
            DigitalFemsa.net.Client.ApiResponse<CompanyResponse> localVarResponse = await GetCompanyWithHttpInfoAsync(id, acceptLanguage, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (CompanyResponse)</returns>
        public async System.Threading.Tasks.Task<DigitalFemsa.net.Client.ApiResponse<CompanyResponse>> GetCompanyWithHttpInfoAsync(string id, string acceptLanguage = default(string), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'id' is set
            if (id == null)
            {
