...
namespace DigitalFemsa.net.Api
{
    ...
    public partial class ChargesApi : IChargesApi
    {
        ...
        /// <returns></returns>
        public ChargesApi(DigitalFemsa.net.Client.Configuration configuration)
        {
        ...
        public ChargesApi(DigitalFemsa.net.Client.ISynchronousClient client, DigitalFemsa.net.Client.IAsynchronousClient asyncClient, DigitalFemsa.net.Client.IReadableConfiguration configuration)
        {
        ...
        {
            DigitalFemsa.net.Client.ApiResponse<ChargeOrderResponse> localVarResponse = OrdersCreateChargeWithHttpInfo(id, chargeRequest, acceptLanguage, xChildCompanyId);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of ChargeOrderResponse</returns>
        public DigitalFemsa.net.Client.ApiResponse<ChargeOrderResponse> OrdersCreateChargeWithHttpInfo(string id, ChargeRequest chargeRequest, string acceptLanguage = default(string), string xChildCompanyId = default(string), int operationIndex = 0)
        {
            // verify the required parameter 'id' is set
            if (id == null)
            {
                throw new DigitalFemsa.net.Client.ApiException(400, "Missing required parameter 'id' when calling ChargesApi->OrdersCreateCharge");
            }

            // verify the required parameter 'chargeRequest' is set
            if (chargeRequest == null)
            {
                throw new DigitalFemsa.net.Client.ApiException(400, "Missing required parameter 'chargeRequest' when calling ChargesApi->OrdersCreateCharge");
            }
        ...
        {
            DigitalFemsa.net.Client.ApiResponse<ChargeOrderResponse> localVarResponse = await OrdersCreateChargeWithHttpInfoAsync(id, chargeRequest, acceptLanguage, xChildCompanyId, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        {
            DigitalFemsa.net.Client.ApiResponse<ChargeResponse> localVarResponse = UpdateChargeWithHttpInfo(id, chargeUpdateRequest, acceptLanguage, xChildCompanyId);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of ChargeResponse</returns>
        public DigitalFemsa.net.Client.ApiResponse<ChargeResponse> UpdateChargeWithHttpInfo(string id, ChargeUpdateRequest chargeUpdateRequest, string acceptLanguage = default(string), string xChildCompanyId = default(string), int operationIndex = 0)
        {
            // verify the required parameter 'id' is set
            if (id == null)
            {
                throw new DigitalFemsa.net.Client.ApiException(400, "Missing required parameter 'id' when calling ChargesApi->UpdateCharge");
            }

            // verify the required parameter 'chargeUpdateRequest' is set
            if (chargeUpdateRequest == null)
            {
                throw new DigitalFemsa.net.Client.ApiException(400, "Missing required parameter 'chargeUpdateRequest' when calling ChargesApi->UpdateCharge");
            }
        ...
        {
            DigitalFemsa.net.Client.ApiResponse<ChargeResponse> localVarResponse = await UpdateChargeWithHttpInfoAsync(id, chargeUpdateRequest, acceptLanguage, xChildCompanyId, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
