...
namespace DigitalFemsa.net.Model
{
    ...
    public partial class CreateCustomerFiscalEntitiesResponse : IValidatableObject
    {
        ...
        public CreateCustomerFiscalEntitiesResponse(CustomerAddress address = default(CustomerAddress), string taxId = default(string), string name = default(string), string email = default(string), string phone = default(string), Dictionary<string, Object> metadata = default(Dictionary<string, Object>), string id = default(string), string varObject = default(string), long createdAt = default(long), string parentId = default(string), bool varDefault = default(bool))
        {
