...
namespace DigitalFemsa.net.Model
{
    ...
    public partial class ShippingOrderResponse : IValidatableObject
    {
        ...
        public ShippingOrderResponse(long amount = default(long), string carrier = default(string), string trackingNumber = default(string), string method = default(string), string description = default(string), Dictionary<string, Object> metadata = default(Dictionary<string, Object>), string id = default(string), string varObject = default(string), string parentId = default(string))
        {
            this.Amount = amount;
        ...
        /// Gets or Sets Id
        /// </summary>
        /// <example>ship_lin_2sLxi45ZFs1GHJmzx</example>
        ...
        /// </summary>
        /// <example>ord_2sLxi3MqYFJ1QfTmP</example>
