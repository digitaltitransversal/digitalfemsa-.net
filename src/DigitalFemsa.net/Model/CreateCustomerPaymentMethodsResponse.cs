...
namespace DigitalFemsa.net.Model
{
    ...
    public partial class CreateCustomerPaymentMethodsResponse : AbstractOpenAPISchema, IValidatableObject
    {
        ...
        public override Object ActualInstance
        {
            ...
            set
            {
                if (value.GetType() == typeof(PaymentMethodCashResponse))
                {
                    this._actualInstance = value;
                }
                else
                {
                    throw new ArgumentException("Invalid instance found. Must be the following types: PaymentMethodCashResponse");
                }
            }
        }
            ...
            try
            {
                ...
                switch (discriminatorValue)
                {
                    ...
                    case "payment_method_cash_response":
                        ...
                        return newCreateCustomerPaymentMethodsResponse;
                    default:
                        System.Diagnostics.Debug.WriteLine(string.Format("Failed to lookup discriminator value `{0}` for CreateCustomerPaymentMethodsResponse. Possible values: cash oxxo_recurrent payment_method_cash_response", discriminatorValue));
                        break;
                }
            }
            catch (Exception ex)
