...
namespace DigitalFemsa.net.Model
{
    ...
    public partial class ProductOrderResponse : IValidatableObject
    {
        ...
        public ProductOrderResponse(string name = default(string), int unitPrice = default(int), int quantity = default(int), string sku = default(string), string brand = default(string), string description = default(string), List<string> tags = default(List<string>), Dictionary<string, Object> metadata = default(Dictionary<string, Object>), string id = default(string), string varObject = default(string), string parentId = default(string))
        {
