...
namespace DigitalFemsa.net.Model
{
    ...
    public partial class OrderNextActionResponseRedirectToUrl : IValidatableObject
    {
        ...
        /// </summary>
        /// <param name="url">pay.femsa.com/{id} Indicates the url of the Femsa component to authenticate the flow through 3DS2..</param>
        ...
        /// </summary>
        /// <value>pay.femsa.com/{id} Indicates the url of the Femsa component to authenticate the flow through 3DS2.</value>
        /// <example>https://pay.femsa.com/6fca054a85194c43971ecea35cc519bb</example>
