            ...
            try
            {
                ...
                switch (discriminatorValue)
                {
                    ...
                    case "payment_method_cash_response":
                        ...
                        return newUpdateCustomerPaymentMethodsResponse;
                    default:
                        System.Diagnostics.Debug.WriteLine(string.Format("Failed to lookup discriminator value `{0}` for UpdateCustomerPaymentMethodsResponse. Possible values: cash oxxo_recurrent payment_method_cash_response", discriminatorValue));
                        break;
                }
            }
            catch (Exception ex)
