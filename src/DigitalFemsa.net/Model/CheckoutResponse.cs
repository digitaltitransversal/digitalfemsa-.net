...
namespace DigitalFemsa.net.Model
{
    ...
    public partial class CheckoutResponse : IValidatableObject
    {
        ...
        public CheckoutResponse(List<string> allowedPaymentMethods = default(List<string>), bool canNotExpire = default(bool), int emailsSent = default(int), long expiresAt = default(long), string failureUrl = default(string), string id = default(string), bool livemode = default(bool), Dictionary<string, Object> metadata = default(Dictionary<string, Object>), string name = default(string), bool needsShippingContact = default(bool), string varObject = default(string), int paidPaymentsCount = default(int), int? paymentsLimitCount = default(int?), bool recurrent = default(bool), string slug = default(string), int smsSent = default(int), int startsAt = default(int), string status = default(string), string successUrl = default(string), string type = default(string), string url = default(string))
        {
        ...
        /// </summary>
        /// <example>https://pay.femsa.com/failure</example>
        ...
        /// </summary>
        /// <example>https://pay.femsa.com/success</example>
        ...
        /// Gets or Sets Url
        /// </summary>
        /// <example>https://pay.femsa.com/link/b0bf16c418b9445eba2401604f329dbf</example>
