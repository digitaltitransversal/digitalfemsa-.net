...
namespace DigitalFemsa.net.Model
{
    ...
    public partial class ChargeOrderResponse : IValidatableObject
    {
        ...
        public ChargeOrderResponse(int amount = default(int), ChargeOrderResponseChannel channel = default(ChargeOrderResponseChannel), long createdAt = default(long), string currency = default(string), string customerId = default(string), string description = default(string), string deviceFingerprint = default(string), string failureCode = default(string), string failureMessage = default(string), string id = default(string), bool livemode = default(bool), string varObject = default(string), string orderId = default(string), int? paidAt = default(int?), ChargeOrderResponsePaymentMethod paymentMethod = default(ChargeOrderResponsePaymentMethod), string referenceId = default(string), List<Object> refunds = default(List<Object>), string status = default(string))
        {
            this.Amount = amount;
