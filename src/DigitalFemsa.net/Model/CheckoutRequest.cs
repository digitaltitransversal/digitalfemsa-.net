...
namespace DigitalFemsa.net.Model
{
    ...
    public partial class CheckoutRequest : IValidatableObject
    {
        ...
        public CheckoutRequest(List<string> allowedPaymentMethods = default(List<string>), long expiresAt = default(long), string failureUrl = default(string), string name = default(string), bool onDemandEnabled = default(bool), string successUrl = default(string), string type = default(string))
        {
