...
namespace DigitalFemsa.net.Model
{
    ...
    public partial class CheckoutRequest : IValidatableObject
    {
        ...
        /// <param name="redirectionTime">Number of seconds to wait before redirecting to the success or failure url.</param>
        public CheckoutRequest(List<string> allowedPaymentMethods = default(List<string>), long expiresAt = default(long), string failureUrl = default(string), string name = default(string), bool onDemandEnabled = default(bool), string successUrl = default(string), string type = default(string), int redirectionTime = default(int))
        {
        ...
        /// </summary>
        /// <value>Number of seconds to wait before redirecting to the success or failure url</value>
        /// <example>60</example>
